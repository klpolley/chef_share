...
public class AccountTest {
    ...
    @Test
    void addRecipeToShoppingListTest() {
        ...
        acct.addRecipeToShoppingList(r1);

        assertNotEquals(-1, acct.getShoppingList().getIngredientIndex("Broccoli"));
        assertNotEquals(-1, acct.getShoppingList().getIngredientIndex("Bread"));
        assertNotEquals(-1, acct.getShoppingList().getIngredientIndex("Cheese"));
        assertEquals(-1, acct.getShoppingList().getIngredientIndex("Pasta"));
        assertEquals(-1, acct.getShoppingList().getIngredientIndex("Tomato"));
        assertEquals(-1, acct.getShoppingList().getIngredientIndex("What"));

        acct.addRecipeToShoppingList(r2);

        assertNotEquals(-1, acct.getShoppingList().getIngredientIndex("Broccoli"));
        assertNotEquals(-1, acct.getShoppingList().getIngredientIndex("Bread"));
        assertNotEquals(-1, acct.getShoppingList().getIngredientIndex("Cheese"));
        assertNotEquals(-1, acct.getShoppingList().getIngredientIndex("Pasta"));
        assertNotEquals(-1, acct.getShoppingList().getIngredientIndex("Tomato"));
        assertEquals(-1, acct.getShoppingList().getIngredientIndex("Nope"));
